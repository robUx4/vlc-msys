...
```
export CC="`which x86_64-w64-mingw32-gcc.exe`"; export CXX="`which x86_64-w64-mingw32-g++.exe`"; export AR="`which x86_64-w64-mingw32-ar.exe`"; export STRIP="`which x86_64-w64-mingw32-strip.exe`"
```
or for **x86**
```
export CC="`which i686-w64-mingw32-gcc.exe`"; export CXX="`which i686-w64-mingw32-g++.exe`"; export AR="`which i686-w64-mingw32-ar.exe`"; export STRIP="`which i686-w64-mingw32-strip.exe`"
```
